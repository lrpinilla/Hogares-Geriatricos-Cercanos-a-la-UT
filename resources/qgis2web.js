...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_LocalizacinHogaresGeriatricosCercanosalaUT_3,
      colName: '4_Residentes',
      zoom: 10,
      collapsed: true,
      map: map
    });
...
map.getView().fit([-8373480.224337, 493095.201545, -8371845.697989, 494620.912556], map.getSize());
